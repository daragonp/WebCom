						...
						<div clas="col-md-12">					
							<div class="wrap-address-billing">
								...
								<div class="billing-address"</div>
									...
									<p class="row-in-form">
										...
										<input type="text" name="province" value="" placeholder="Departamento"  wire:model="province">
										@error('province')<span class="text-danger">{{$message}}</span> @enderror
									</p>
									<p class="row-in-form">
										<label for="city">Town / City<span>*</span></label>
										<input type="text" name="city" value="" placeholder="City name"  wire:model="city"><p 
										@error('citys')<span class="text-danger">{{$message}}</span> @enderror
									</p>
							...
							@if($ship_to_different)
								<div clas="col-md-12">					
									...
									<p class="row-in-form">
										<label for="city">Provincia<span>*</span></label>
										<input type="text" name="province" value="" placeholder="Departamento"  wire:model="s_province">
									...
									<p class="row-in-form fill-wife">
										<label class="checkbox-field">
											<input name="different-add" id="different-add" value="1" type="checkbox" wire:model="s_ship_to_different">
											<span>Ship to a different address?</span>
										</label>
									</p>
								</div>
						...
						<div class="summary-item payment-method">
							...
							<div class="choose-payment-methods">
								<label class="payment-method">
									...
									<span>Pagar contra reembolso</span>
									<span class="payment-desc">Paga al momento de recibir el pedido, directo al dependiente</span>
								</label>
								<label class="payment-method">
							...
							@endif
							<button type="submit" class="btn btn-medium">Ordenar</button>
						</div>
